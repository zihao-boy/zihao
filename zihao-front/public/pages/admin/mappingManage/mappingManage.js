    ...
    vc.extends({
        ...
        methods: {
            _listMappings: function (_page, _rows) {
                ...
                //发送get请求
                vc.http.apiGet('/system/getMappings',
                    param,
                    function (json, res) {
                        ...
                        vc.component.mappingManageInfo.mappings = _mappingManageInfo.data;
            ...
            _moreCondition: function () {
                if (vc.component.mappingManageInfo.moreCondition) {
                    vc.component.mappingManageInfo.moreCondition = false;
                } else {
                    vc.component.mappingManageInfo.moreCondition = true;
                }
            }
